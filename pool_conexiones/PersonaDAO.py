from pool_conexiones.Persona import Persona
from logger_base import log
from pool_conexiones.cursor_del_pool import CursorDelPool
...
if __name__ == '__main__':
    ...
    # Inserta un registro
    persona1 = Persona(nombre='Alberto', apellido='Sanchez', email='alberto@gmail.com')
